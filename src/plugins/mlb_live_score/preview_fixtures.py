...
def preview_states() -> dict[str, ScoreboardPresentation]:
    ...
    states = {
        ...
        "final_wp_lp": presentation(base_game(state=GameState.FINAL, status="FINAL", uses_live_layout=False, is_final=True, inning=9, winning_pitcher="Spencer Strider", losing_pitcher="Gerrit Cole", pitcher_name=None, batter_name=None)),
        "final_wp_lp_sv": presentation(base_game(state=GameState.FINAL, status="FINAL", uses_live_layout=False, is_final=True, inning=9, winning_pitcher="Spencer Strider", losing_pitcher="Gerrit Cole", save_pitcher="Raisel Iglesias", pitcher_name=None, batter_name=None)),
